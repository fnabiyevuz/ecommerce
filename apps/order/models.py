...
class Coupon(BaseModel):
    ...
    discount_type = models.CharField(verbose_name=_("Sales type"), max_length=25,
                                     choices=CouponType.choices, default=CouponType.PERCENT)
    amount_discount = models.PositiveIntegerField(verbose_name=_("Amount discount"), default=0)
...
class Order(BaseModel):
    ...
    district = models.ForeignKey('common.District', verbose_name=_("District"), on_delete=models.CASCADE,
                                 related_name='order_district')
    note = models.TextField(verbose_name=_("Note"), null=True, blank=True)
    status = models.CharField(verbose_name=_("Order status"), max_length=10, choices=OrderStatusType.choices,
                              default=OrderStatusType.NEW)
    payment_type = models.CharField(verbose_name=_("Payment type"), max_length=10, choices=PaymentType.choices,
